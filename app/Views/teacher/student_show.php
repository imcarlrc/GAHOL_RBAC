    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-footer bg-white border-top py-3">
                <a href="<?= base_url('management/students') ?>" class="btn btn-outline-secondary">
                    <i class="bi bi-arrow-left me-1"></i>Back to Student List
                </a>
                
                <?php if (session('user')['role_name'] === 'admin'): ?>

                    <a href="<?= base_url('/admin/users/edit/' . $student['id']) ?>" class="btn btn-outline-primary btn-sm">
