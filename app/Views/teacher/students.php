...
<div class="d-flex align-items-center justify-content-between mb-4">
    <!-- Group 1: Title and Badge (Left Side) -->
    ...
    <!-- Group 2: Admin Button (Right Side) -->
    <?php if (in_array(session('user')['role_name'] ?? '', ['admin', 'coordinator'])): ?>
        <a href="<?= base_url('/management/students/create') ?>" class="btn btn-info btn-sm text-white shadow-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center pe-4">
                            <a href="<?= base_url('/management/students/show/' . $s['id']) ?>"
